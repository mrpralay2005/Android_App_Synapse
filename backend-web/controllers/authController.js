    ...
    try {
        ...
        return c.json({
            ...
            user: {
                ...
                notificationPostAlerts: user.notificationPostAlerts,
                notificationStoryAlerts: user.notificationStoryAlerts,
                notificationSecurityAlerts: user.notificationSecurityAlerts,
