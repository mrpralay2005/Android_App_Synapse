...
const AdminCommandCenter = () => {
    ...
    const publish = async (event) => {
        ...
        try {
            ...
            setMessage('Release published. Cloudflare is now building this version for users.');
            await load();
        } catch (error) {
