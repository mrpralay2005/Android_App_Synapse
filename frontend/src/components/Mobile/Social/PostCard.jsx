...
const PostCard = ({ post, onInteraction, onCinemaMode, index = 0 }) => {
    ...
    const mobileHideTimer = useRef(null);
    ...
    useEffect(() => {
        ...
        setShowMobileChrome(true);
        if (mobileHideTimer.current) clearTimeout(mobileHideTimer.current);
        mobileHideTimer.current = setTimeout(() => {
                            ...
                            <div className="flex items-center justify-between p-4 pointer-events-auto">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-2 text-white">
                                        ...
                                        <span className="text-[9px] uppercase tracking-[0.2em] text-emerald-500">Live</span>
                                    </div>
                                </div>
                                <button
                ...
                <div className="absolute top-4 right-4 z-40">
                    <div className="rounded-[1.2rem] border border-white/10 bg-black/80 p-2 shadow-2xl backdrop-blur-md">
                        <button
                            ...
                            className="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-left text-sm font-medium text-white hover:bg-white/5"
                        >
