...
const ForgotPasswordBox = ({ onBack, onSuccess }) => {
    ...
    return (
        <div className="mobile-auth-screen relative h-full min-h-0 w-full flex items-center justify-center overflow-hidden">
            ...
            <motion.button
                ...
                onClick={onBack}
                className="mobile-auth-back absolute top-8 left-8 z-50 p-3 rounded-full bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-all group backdrop-blur-md"
            >
